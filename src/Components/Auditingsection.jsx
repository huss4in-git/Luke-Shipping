...
export default function Auditingsection() {
    ...
    const challenges = [
        ...
        },
        {
            ...
            desc: "Internal and external stakeholders expect your products and processes to be safe, high-quality, compliant, and sustainable. Audit services can help ensure this.",
        },
            ...
            <section className="bg-[#f3f3f3] py-16 px-6 md:px-16" style={{ fontFamily: "nb-thin" }}>
                <div className="max-w-8xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                    <div className="max-w-xl">
                        ...
                        Our experts have the deep knowledge to help you overcome your most common challenges through our auditing services.                       </p>
                    </div>
