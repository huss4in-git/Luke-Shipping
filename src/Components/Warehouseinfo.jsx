...
const features = [
  "Comprehensive project planning and coordination for complex logistics operations",
  "Specialized handling of heavy-lift and out-of-gauge cargo",
  "End-to-end project execution from concept to final delivery",
  "Customized solutions tailored to unique project requirements",
  "Expertise across industries including construction, energy and oil & gas",
  "Efficient route planning and reliable transport management",
  "Seamless customs clearance and regulatory compliance support",
  "Dedicated project team ensuring precision and control at every stage",
  "Risk-managed operations focused on safety and minimal disruption",
  "Cost-efficient execution without compromising timelines or quality",
];
    ...
    <section ref={sectionRef} className="bg-white w-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 mt-10 mb-10 lg:mt-15 lg:mb-35">
        ...
        <div className="flex flex-col justify-between md:mt-0 mt-5 px-6 lg:px-10 mb-8 lg:mb-0">
          ...
          >
            We manage complex <br /> projects with precision <br /> and complete control.
          </h2>
