...
const services = [
  ...
  { id: 3, title: "ESG Supplier Audits", categories: ["Sustainability", "Consumer Products and Retail","Automotive","Rail", "Building and Construction"], Icon: ShoppingCart },
  { id: 4, title: "Energy Certification", categories: ["Sustainability", "Energy"], Icon: Factory },
  { id: 5, title: "Food Hygiene Audits", categories: ["Consumer Products and Retail"], Icon: UtensilsCrossed },
  { id: 6, title: "SMETA Certification", categories: ["Sustainability", "Manufacturing","Rail", "Consumer Products and Retail", "Automotive", "Building and Construction"], Icon: Globe },
  { id: 7, title: "Supplier Audits", categories: ["Consumer Products and Retail"], Icon: ShoppingBasket },
  { id: 8, title: "Worldwide Responsible Accredited Production (WRAP) Certification", categories: ["Consumer Products and Retail"], Icon: Building2 },
  { id: 9, title: "amfori Business Environmental Performance Initiative (BEPI)", categories: ["Sustainability","Consumer Products and Retail", "Manufacturing"], Icon: File },
  { id: 10, title: "amfori Business Social Compliance Initiative (BSCI)", categories: ["Sustainability","Consumer Products and Retail"], Icon: NotepadText },
  { id: 11, title: "amfori Quality Management Initiative (QMI)", categories: ["Consumer Products and Retail"], Icon: FileCheck  },
