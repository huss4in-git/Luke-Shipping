...
export default function Road() {
    ...
    const heroImgRef = useRef(null); // 👈 add this
            ...
            <section className="h-screen relative overflow-hidden">
                ...
                <div className="hidden md:flex absolute inset-0 items-end pb-35 px-12 text-left text-white" style={{ fontFamily: 'nb-thin' }}>
                    <div className="max-w-4xl">
                        ...
                        <div className="mt-6 max-w-xl text-sm opacity-90">
                            <span style={{ color: '#FD9708' }}>Luke Shipping Co.</span> has stood for reliable truck transport
                            and general cargo shipping. With a modern fleet and a strong
                            network, we deliver parcels, general cargo and partial and full loads
                            nationally and internationally punctually and safely to their
                            destination.
                        </div>
                ...
                <div className="md:hidden absolute bottom-28 left-0 right-0 px-6 text-white" style={{ fontFamily: 'nb-thin' }}>
                    ...
                    <p className="text-xs opacity-90">
                        Reliable truck transport and general cargo shipping with a strong
                        network delivering safely and on time.
                    </p>
