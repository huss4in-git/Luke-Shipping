    ...
    <>
      ...
      <section className="h-screen relative overflow-hidden">
        ...
        <div className="hidden md:flex absolute inset-0 items-end pb-35 px-12 text-left text-white" style={{ fontFamily: 'nb-thin' }}>
          <div className="max-w-4xl">
            ...
            <Link to="/" className="hover:text-[#FD9708] transition-colors">Home</Link> / About Us
            </p>

            <h1 className="text-6xl md:text-6xl">
              Dedicated to transport and logistics
              since 2015.
            </h1>
            ...
            <div className="mt-6 max-w-xl text-sm opacity-90">
              ...
              benefit with our customers. This has enabled us to grow
              continuously over time, even during the most hard-hitting crises.
              This is our objective: to keep growing together.
            </div>
      ...
      >
        ...
        <div className="relative overflow-hidden h-full">
          <div
            className={`flex w-[200%] transition-transform duration-500 ${activeMenu === "services"
                ? "-translate-x-1/2"
                : "translate-x-0"
              }`}
          >
