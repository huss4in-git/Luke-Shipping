...
import { UserCheck, ClipboardCheck, TrendingUp, ShieldAlert, ClipboardList, Clock, FileSearch, Users, Award } from "lucide-react";
        ...
        <>
            ...
            <section className="h-[50vh] relative overflow-hidden" style={{ fontFamily: "nb-thin" }}>
                ...
                <div className="hidden md:flex absolute inset-0 items-end pb-24 px-16 text-white">
                    <div className="flex items-end justify-between w-full">
                        <div className="max-w-2xl">
                            <p className="text-sm mb-4 opacity-60">Home / Services / Testing</p>
                            <h1 className="text-6xl leading-tight">Product Testing</h1>
                            <p className="mt-4 max-w-xl text-sm opacity-75">
                            Ensures quality and safety of products through testing in accredited labs globally according to regulatory, market and companies’ requirements.
                            </p>
                        ...
                        <div className="flex-shrink-0 opacity-75 mb-2">
                            <ClipboardList size={150} strokeWidth={0.9} color="#FD9708" />
                        </div>
                    </div>
                </div>
                ...
                <div className="md:hidden absolute bottom-12 left-0 right-0 px-6 text-white">
                    <p className="text-[11px] mb-3 opacity-60">Home / Services / Testing</p>
                    <h1 className="text-3xl leading-tight mb-3">Product Testing</h1>
                    <p className="text-xs opacity-70 mb-5">Ensures quality and safety of products through testing in accredited labs globally according to regulatory, market and companies’ requirements.</p>
