...
import { UserCheck, ClipboardCheck, TrendingUp, ShieldAlert, Clock, FileSearch, Users, FileCheck } from "lucide-react";
                ...
                <div className="hidden md:flex absolute inset-0 items-end pb-20 px-16 text-white">
                    <div className="flex items-end justify-between w-full">
                        ...
                        <div className="flex-shrink-0 opacity-75 mb-2">
                            <FileCheck size={150} strokeWidth={0.9} color="#FD9708" />
                        </div>
                    </div>
                </div>
